  ...
  return (
    <div className="space-y-8">
      <h2 className="text-3xl font-bold font-headline text-center text-primary">
        {editingId ? 'Edit Waste Listing' : 'List Item in WasteShop'}
      </h2>
      <Card className="shadow-lg">
        <form onSubmit={handleSubmit}>
          <CardHeader>
            ...
            <CardDescription>Offer your recyclable or reusable items to others in the WasteShop.</CardDescription>
          </CardHeader>
      ...
      <section className="mt-8">
        <h3 className="text-2xl font-semibold font-headline mb-4 text-foreground">WasteShop Items</h3>
        {listings.length === 0 ? (
